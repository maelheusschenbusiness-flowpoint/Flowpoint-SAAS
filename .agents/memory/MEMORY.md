...
- [AI Attachments Contract](ai-attachments-contract.md) — Step 3A: fileId refs only, 3-stage pipeline, 501 before provider, AI MIME allowlist stricter than team-files
