...
CREATE OR REPLACE POLICY rls_org_isolation ON audits
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE audit_schedules         ENABLE ROW LEVEL SECURITY;
ALTER TABLE audit_schedules         FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON audit_schedules
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE alert_rules             ENABLE ROW LEVEL SECURITY;
ALTER TABLE alert_rules             FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON alert_rules
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE monitors                ENABLE ROW LEVEL SECURITY;
ALTER TABLE monitors                FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON monitors
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE monitor_checks          ENABLE ROW LEVEL SECURITY;
ALTER TABLE monitor_checks          FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON monitor_checks
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE competitors             ENABLE ROW LEVEL SECURITY;
ALTER TABLE competitors             FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON competitors
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE keywords                ENABLE ROW LEVEL SECURITY;
ALTER TABLE keywords                FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON keywords
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE reports                 ENABLE ROW LEVEL SECURITY;
ALTER TABLE reports                 FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON reports
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE report_exports          ENABLE ROW LEVEL SECURITY;
ALTER TABLE report_exports          FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON report_exports
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE notifications           ENABLE ROW LEVEL SECURITY;
ALTER TABLE notifications           FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON notifications
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE team_members            ENABLE ROW LEVEL SECURITY;
ALTER TABLE team_members            FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON team_members
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE team_messages           ENABLE ROW LEVEL SECURITY;
ALTER TABLE team_messages           FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON team_messages
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE connectors              ENABLE ROW LEVEL SECURITY;
ALTER TABLE connectors              FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON connectors
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE cro_experiments         ENABLE ROW LEVEL SECURITY;
ALTER TABLE cro_experiments         FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON cro_experiments
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE cro_recommendations     ENABLE ROW LEVEL SECURITY;
ALTER TABLE cro_recommendations     FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON cro_recommendations
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE cro_scores              ENABLE ROW LEVEL SECURITY;
ALTER TABLE cro_scores              FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON cro_scores
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE revenue_leaks           ENABLE ROW LEVEL SECURITY;
ALTER TABLE revenue_leaks           FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON revenue_leaks
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE workflow_runs           ENABLE ROW LEVEL SECURITY;
ALTER TABLE workflow_runs           FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON workflow_runs
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE automation_templates    ENABLE ROW LEVEL SECURITY;
ALTER TABLE automation_templates    FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON automation_templates
  USING (org_id = current_setting('app.current_org_id', true));

ALTER TABLE activity_logs           ENABLE ROW LEVEL SECURITY;
ALTER TABLE activity_logs           FORCE ROW LEVEL SECURITY;
CREATE OR REPLACE POLICY rls_org_isolation ON activity_logs
  USING (org_id = current_setting('app.current_org_id', true));
...
CREATE OR REPLACE POLICY rls_org_isolation ON crm_field_mappings
  USING (org_id = current_setting('app.current_org_id', true));
